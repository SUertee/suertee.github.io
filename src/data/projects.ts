...
const projectOverrides: Record<string, Partial<Record<LanguageKey, ProjectCopy>>> =
  {
    "ai-game": {
      zh: {
        name: "AI 游戏化项目管理学习平台",
    ...
    vsas: {
      zh: {
        ...
        role: "全栈开发 & 系统测试",
        shortDescription: "具备 RBAC、REST 集成与高测试覆盖率的安全访问控制平台。",
        highlights: [
...
export function localizeProject(project: Project, language: LanguageKey): Project {
